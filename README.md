# API-Testing-project
# This project is designed to test the API for storing information about memes using Requests and Pytest libraries. These automated tests can be easily run with https://github.com/Azamat-V-U/API-Testing-project/actions GitHub Actions.
