...
invalid_headers = [
    {"Authorization": "j92NzL2mMwGayfyQ"},
    {"Authorization": ""},
    {}
]
...
def test_delete_meme(meme_id_old_token, delete_meme_endpoint):
    delete_meme_endpoint.delete_one_meme(meme_id=meme_id_old_token)
...
@pytest.mark.low
def test_delete_meme_with_other_user_token(meme_id_new_token, delete_meme_endpoint):
    delete_meme_endpoint.delete_one_meme(meme_id=meme_id_new_token)
    delete_meme_endpoint.status_code_verification(status_code=403)
    delete_meme_endpoint.forbidden_response_message()
...
def test_delete_meme_url_empty_meme_id(delete_meme_endpoint):
    ...
    delete_meme_endpoint.not_allowed_response_message()
...
def test_delete_meme_invalid_headers(delete_meme_endpoint, new_meme_id_int, invalid_test_headers):
    delete_meme_endpoint.delete_meme_invalid_headers(meme_id=new_meme_id_int, headers=invalid_test_headers)
    delete_meme_endpoint.status_code_verification(status_code=401)
    delete_meme_endpoint.unauthorized_response_message()
